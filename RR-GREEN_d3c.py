...
# YOUR FATHER MR. SAJJAD OK
# NEXT NO ABLAMI 
# OPEN CODE UPLOAD BY SAJJAD
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t			 WELLCOME : [green]ENJOY SAJJAD PUBLIK TOOL[purple] '))
...
def notice():
	...
	time.sleep(2)
	os.system('am start https://wa.me/+8801840215106')
